...
//===----------------------------------------------------------------------===//
//
// HTTPObjectAggregatorTest+XCTest.swift
//
import XCTest
...
extension HTTPServerRequestAggregatorTest {

   @available(*, deprecated, message: "not actually deprecated. Just deprecated to allow deprecated tests (which test deprecated functionality) without warnings")
   static var allTests : [(String, (HTTPServerRequestAggregatorTest) -> () throws -> Void)] {
      return [
...
extension HTTPClientResponseAggregatorTest {

   @available(*, deprecated, message: "not actually deprecated. Just deprecated to allow deprecated tests (which test deprecated functionality) without warnings")
   static var allTests : [(String, (HTTPClientResponseAggregatorTest) -> () throws -> Void)] {
      return [
