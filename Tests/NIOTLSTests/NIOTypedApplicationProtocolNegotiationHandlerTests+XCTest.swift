...
//===----------------------------------------------------------------------===//
//
// NIOTypedApplicationProtocolNegotiationHandlerTests+XCTest.swift
//
import XCTest
...
extension NIOTypedApplicationProtocolNegotiationHandlerTests {

   @available(*, deprecated, message: "not actually deprecated. Just deprecated to allow deprecated tests (which test deprecated functionality) without warnings")
   static var allTests : [(String, (NIOTypedApplicationProtocolNegotiationHandlerTests) -> () throws -> Void)] {
      return [
