...
extension NIOConcurrencyHelpersTests {
   ...
   static var allTests : [(String, (NIOConcurrencyHelpersTests) -> () throws -> Void)] {
      return [
                ...
                ("testLargeContendedFastAtomicSum", testLargeContendedFastAtomicSum),
                ("testCompareAndExchangeBoolFastAtomic", testCompareAndExchangeBoolFastAtomic),
                ("testAllOperationsBoolFastAtomic", testAllOperationsBoolFastAtomic),
                ("testCompareAndExchangeUIntsFastAtomic", testCompareAndExchangeUIntsFastAtomic),
                ("testCompareAndExchangeIntsFastAtomic", testCompareAndExchangeIntsFastAtomic),
                ("testAddSubFastAtomic", testAddSubFastAtomic),
                ("testExchangeFastAtomic", testExchangeFastAtomic),
                ("testLoadStoreFastAtomic", testLoadStoreFastAtomic),
