...
class VsockAddressTest: XCTestCase {
    ...
    // Getting vsock addresses is not available on Windows.
    #if !os(Windows)
    ...
    func testGetRemoteVsockAddressRejectsNonVsockSocket() throws {
        // A socketpair gives us a connected non-vsock socket without binding anything.
        var fds: [CInt] = [-1, -1]
    ...
    func testGetRemoteVsockAddressOverLoopback() throws {
        ...
        // Both ends of a loopback connection live in the same context.
