    ...
    func testWeDoNotDeliverEventsForPreviouslyClosedChannels() {
        ...
        class CloseEveryOtherAndOpenNewOnesHandler: ChannelInboundHandler {
            ...
            func channelActive(context: ChannelHandlerContext) {
                ...
                context.channel.getOption(option: ChannelOptions.allowRemoteHalfClosure).whenSuccess { halfClosureAllowed in
            ...
            func userInboundEventTriggered(context: ChannelHandlerContext, event: Any) {
                ...
                for _ in everyOtherIndex {
                    ...
                    let p: EventLoopPromise<Void> = context.channel.eventLoop.newPromise()
                ...
                EventLoopFuture<Void>.andAll(reconnectedChannelsHaveRead,
                                             eventLoop: context.eventLoop).cascade(promise: self.everythingWasReadPromise)
