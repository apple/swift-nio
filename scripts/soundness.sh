...
for language in swift-or-c bash dtrace python; do
  ...
  case "$language" in
      swift-or-c)
        exceptions=(    -name c_nio_http_parser.c -o -name c_nio_http_parser.h
                     -o -name cpp_magic.h -o -name Package.swift
                     -o -name CNIOSHA1.h -o -name c_nio_sha1.c
                     -o -name ifaddrs-android.c -o -name ifaddrs-android.h
                     -o -path ./Sources/NIO/VendoredDeque/\*.swift )
