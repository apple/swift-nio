...
internal enum BufferedOrAnyStream<Element: Sendable, Delegate: NIOAsyncSequenceProducerDelegate>: Sendable {
    ...
    internal init<S: AsyncSequence & Sendable>(wrapping stream: S) where S.Element == Element, S.AsyncIterator: _NIOFileSystemSendableMetatype {
...
internal struct AnyAsyncSequence<Element>: AsyncSequence, Sendable {
    ...
    internal init<S: AsyncSequence & Sendable>(wrapping sequence: S) where S.Element == Element, S.AsyncIterator: _NIOFileSystemSendableMetatype { 
