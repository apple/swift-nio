...
extension OpenOptions {
    ...
    public struct NewFile: Sendable, Hashable {
        ...
        /// ``FileSystemProtocol/withFileHandle(forWritingAt:options:execute:)-(NIOFilePath,_,_)`` and
        /// ``FileSystemProtocol/withFileHandle(forReadingAndWritingAt:options:execute:)-(NIOFilePath,_,_)`` the
