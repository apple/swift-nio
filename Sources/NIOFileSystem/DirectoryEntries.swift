...
public struct DirectoryEntries: AsyncSequence, Sendable {
    ...
    /// directory entries.
    @preconcurrency
    public init<S: AsyncSequence & Sendable>(wrapping sequence: S) where S.Element == Batched.Element, S.AsyncIterator: _NIOFileSystemSendableMetatype {
...
extension DirectoryEntries {
    ...
    public struct Batched: AsyncSequence, Sendable {
        ...
        @preconcurrency
        public init<S: AsyncSequence & Sendable>(wrapping sequence: S) where S.Element == Element, S.AsyncIterator: _NIOFileSystemSendableMetatype {
