...
private final class EchoHandler: ChannelInboundHandler {
    ...
    // Flush it out. This can make use of gathering writes if multiple buffers
    // are pending.
...
let bootstrap = ServerBootstrap(group: group)
    ...
    .childChannelInitializer { channel in
        // Ensure we don't read faster then we can write by adding the
        // BackPressureHandler into the pipeline.
