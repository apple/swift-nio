    ...
    try _storage.update { handle in
      ...
      defer {
        ...
        precondition(buffer.baseAddress == b.baseAddress && buffer.count == b.count,
          "Initializer relocated NIODeque storage")
        handle.count = count
      }
...
extension NIODeque {
  ...
  /* was @inlinable */
  @usableFromInline internal /*was public */ mutating func popFirst() -> Element? {
  ...
  /// - SeeAlso: `append(_:)`
  /* was @inlinable */
  @usableFromInline internal /*was public */ mutating func prepend(_ newElement: Element) {
  ...
  /* was @inlinable */
  @usableFromInline internal /*was public */ mutating func prepend<C: Collection>(contentsOf newElements: C) where C.Element == Element {
  ...
  /// - SeeAlso: `append(contentsOf:)`
  /* was @inlinable */
  @usableFromInline internal /*was public */ mutating func prepend<S: Sequence>(contentsOf newElements: S) where S.Element == Element {
