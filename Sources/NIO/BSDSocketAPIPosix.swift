...
//===----------------------------------------------------------------------===//
    ...
    extension NIOBSDSocket {
        ...
        {
            try Posix.getsockopt(socket: socket,
        ...
        {
            try Posix.setsockopt(socket: socket,
                                 level: level.rawValue,
                                 optionName: optname.rawValue,
                                 optionValue: optval,
                                 optionLen: optlen)
        ...
        {
            try Posix.socket(domain: af, type: type, protocol: `protocol`)
        }
        ...
        {
            try Posix.recvmmsg(sockfd: socket,
                               msgvec: msgvec,
                               vlen: vlen,
                               flags: flags,
                               timeout: timeout)
        ...
        {
            try Posix.sendmmsg(sockfd: socket,
                               msgvec: msgvec,
                               vlen: vlen,
                               flags: flags)
        }
        ...
        {
            try Posix.pread(descriptor: socket,
                            pointer: pointer,
                            size: size,
                            offset: offset)
        }
        ...
        {
            try Posix.inet_pton(addressFamily: sa_family_t(family.rawValue),
