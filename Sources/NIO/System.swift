...
internal enum Posix {
        ...
        static let IP_RECVPKTINFO = CInt(CNIOLinux.IP_PKTINFO)
        static let IP_PKTINFO = CInt(CNIOLinux.IP_PKTINFO)
        static let IPV6_RECVPKTINFO = CInt(CNIOLinux.IPV6_RECVPKTINFO)
        static let IPV6_PKTINFO = CInt(CNIOLinux.IPV6_PKTINFO)
    #else
...
#if !os(Windows)
    extension Posix {
        internal static func setNonBlocking(socket: CInt) throws {
